...
from APP_UserManagement import SECRET_KEY_FLASK
from APP_UserManagement import DEBUG_FLASK
from APP_UserManagement import ADRESSE_SRV_FLASK
from APP_UserManagement import PORT_FLASK
